...
const translations = {
  en: {
    ...
    heroBadge: 'v1.8.7 Industrial Suite • 50 Core Tools',
  ...
  ru: {
    ...
    heroBadge: 'v1.8.7 Industrial Suite • 50 Промышленных Инструментов',
    heroTitlePrefix: 'KUKA KRL Professional — ',
  ...
  tr: {
    ...
    heroBadge: 'v1.8.7 Endüstriyel Paket • 50 Temel Araç',
    heroTitlePrefix: 'KUKA KRL Professional — ',
