...
Мгновенное выпадающее меню при вводе `$` с подсказками по 350+ системным переменным (`$POS_ACT`, `$VEL.CP`, `$BASE`, `$TOOL`, `$IN`, `$OUT`).

![Smart Autocomplete Demo](/media/smart_autocomplete.gif)

---

### 4. Мультиязычность 6 языков (EN / DE / RU / ES / IT / TR)
Полная локализация интерфейса расширения, подсказок, меню команд и дашборда Control Center на 6 языках: английский, немецкий, русский, испанский, итальянский и турецкий.
