...
* 💻 **Тариф на 5 активаций (Pro Monthly / Annual / Lifetime):**
  * Лицензия на **5 одновременных активаций устройств** (рабочий ноутбук, полевой Toughbook, офисный ПК, домашний компьютер, тестовый стенд).
  * **Почему Pro Lifetime ($699 разово)?** Вы платите один раз и получаете постоянный доступ без абонентской платы и регулярных списаний. Любая предотвращённая авария робота или сэкономленный день пусконаладки окупает эту стоимость мгновенно.
* 🏢 **Тариф на 25 активаций (Team Edition — $299/год):**
  * Пакет из **25 активаций устройств** для всей команды интеграции.
  * Централизованная оплата по B2B-счёту, закрывающие акты для бухгалтерии и единый корпоративный стандарт качества KRL-кода на всех проектах.
* 🏭 **Enterprise для завода (Enterprise Site — $1,499/год):**
  * *Почему годовая лицензия $1,499/год, если бессрочный тариф на 5 устройств стоит $699?*
  * Потому что это **БЕЗЛИМИТНЫЕ АКТИВАЦИИ НА ВЕСЬ ЗАВОД (Unlimited Seats)**! Лицензия покрывает не 5 устройств, а **все компьютеры, стенды и пульты предприятия (20, 50 или 100+ наладчиков, операторов и ремонтников)**. Для команды из 15 специалистов это всего **~$8 в месяц на рабочее место**!
